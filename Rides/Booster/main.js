...
cameraPOV.position.x = 2;
cameraPOV.position.y = 1.2;
...
mainBody.position.set(-2, 21.5, 0);
world.addBody(mainBody);

const ArmShape = new CANNON.Box(new CANNON.Vec3(0.4, 19, 0.2));
const armBody = new CANNON.Body({ mass: 5000, shape: ArmShape });
...
const plateHingeConstraint = new CANNON.HingeConstraint(mainBody, armBody, {
  ...
  pivotB: new CANNON.Vec3(0, 0, -1.5), // Center of the bottom face of the cylinder
...
const Gondel1Shape = new CANNON.Box(new CANNON.Vec3(0.5, 0.75, 0.5));
const Gondel1Body = new CANNON.Body({ mass: 400, shape: Gondel1Shape });
...
const GondelConstraint1 = new CANNON.HingeConstraint(armBody, Gondel1Body, {
  ...
  pivotB: new CANNON.Vec3(0, 0.2, -1), // Center of the bottom face of the cylinder
  axisB: new CANNON.Vec3(0, 0, 1), // Axis of rotation for the cylinder
});
...
function animate() {
  ...
  if(kmgspeedgondel1 != null) syncObjectWithBody(kmgspeedarm, armBody);
